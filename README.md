...
- [x] Participer à des réunions de travail avec les utilisateurs
...
- [x] Connaissance d'une démarche de développement en approche de type Agile
- [x] Connaissance du vocabulaire professionnel technique en français et en anglais
- [x] Connaissance du formalisme des cas d'utilisation et du __diagramme d'état ou d’activité__ et de l'__UML__
...
- [x] Utiliser un framework de type adaptatif, y compris pour le web mobile (__React__, __Angular__, __VueJs__)
...
- [x] Planifier et suivre les tâches de développement methode __Scrumm, Agile__
...
- [x] Connaissance des bonnes pratiques de qualité incluant __l’écoconception logicielle__
- [x] Connaissance des langages du développement web, tels que langage de balise et feuilles de style
- [x] Connaissance d’un framework de présentation de type adaptatif
- [x] Connaissance des règles d’accessibilité des contenus web du type __WCAG__
...
- [x] Améliorer le site en utilisant des mécanismes __asynchrones__ (de type __AJAX__, ...)
- [x] Corriger les erreurs et remédier aux vulnérabilités détectées
- [x] __Documenter__ les scripts client
...
- [x] Rendre visible le site sur les moteurs de recherche avec les techniques de référencement naturel
- [x] Rechercher une réponse pertinente à une difficulté technique de développement ou une vulnérabilité identifiée
...
- [x] Connaissance d'un environnement de développement
- [x] Connaissance du vocabulaire anglais professionnel associé au web
- [x] Connaissance des bonnes pratiques de qualité incluant l'__écoconception web__
...
- [x] Connaissance des langages et framework de script client
- [ ] Connaissance des principales failles de sécurité des applications web (__XSS__, __CSRF__…) et de leurs parades
- [x] Connaissance des bonnes pratiques de sécurisation des clients web (code non intrusif, validations des entrées…)
...
- [x] Utiliser un outil collaboratif de partage de fichiers
- [x] Rédiger un guide utilisateur à destination des utilisateurs
...
- [x] Générer un script de création de la base de données à l'aide de l'outil de modélisation
...
- [x] Planifier et suivre les tâches de mise en place de la base de données
- [x] Utiliser un outil collaboratif de partage de fichiers
- [x] Rechercher une réponse pertinente à une difficulté technique de développement ou une vulnérabilité identifiée
...
- [x] Connaissance des __avantages et inconvénients du relationnel et du non-relationnel__
...
- [x] Connaissance des bonnes pratiques de sécurisation : choix du __mode d’authentification__, gestion des comptes, __politique de mots de passe__
...
- [x] Coder des composants dans __un langage objet__, avec un style de __programmation défensif__
- [x] Utiliser des bibliothèques d'objets existants
...
- [x] __Documenter__ les composants
...
- [x] Connaissance des règles orthographiques et grammaticales
- [x] Connaissance du vocabulaire professionnel technique en français et en anglais
- [x] Connaissance d'un environnement de développement intégré
- [x] Connaissance des opérations standards permettant la gestion d’une collection d’éléments
- [x] Connaissance du langage de requête de type SQL
- [x] Connaissance des modèles de conception relatifs aux accès aux données
...
### Savoir-faire techniques, organisationnels, relationnels
- [x] Utiliser un environnement de développement intégré y compris en anglais
- [x] Écrire un algorithme
- [x] Développer dans un langage objet
- [x] Développer la partie dynamique de l'application avec des composants serveurs, dans un __style défensif__, et éventuellement en __asynchrone__
- [ ] Appeler des Web Services dans un composant serveur
- [x] Documenter les pages de code
- [x] Sécuriser la liaison entre le client et le serveur web
...
- [x] Prendre en compte les contraintes des applications multilingues
...
- [ ] Utiliser un outil de gestion de versions de code source
- [x] Rechercher une réponse pertinente à une difficulté technique de développement
- [x] Rechercher des informations sur des sites Internet, des forums et des FAQ francophones ou anglophones
- [x] Utiliser un outil collaboratif de partage de fichiers
- [x] Connaissance du vocabulaire anglais professionnel associé au web
- [x] Connaissance d'un environnement de développement intégré
- [x] Connaissance des principes de communication du web
- [ ] Connaissance liée aux objets connectés (protocole de communication, …)
- [x] Connaissance des concepts de la programmation objet
- [x] Connaissance des bonnes pratiques de qualité et d’écoconception web
...
- [x] Utiliser un environnement de développement intégré y compris en anglais
- [x] Développer dans un langage objet
- [x] Développer la partie dynamique de l'application avec des composants serveurs, dans un style défensif, et
- [x] éventuellement en asynchrone
- [x] Appeler dans le composant serveur des services web
- [x] Prendre en compte les contraintes des applications multilingues
- [x] Documenter les pages de code
- [x] Gérer la sécurité de l’application (authentification, permissions…) dans la partie serveur
- [x] Réaliser un jeu de tests de l'application web
- [x] Effectuer un achat test sur la boutique en ligne
- [ ] Tester la sécurité du site, avec un guide de test reconnu (par exemple, celui d’__OWASP__)
...
- [x] Rechercher des informations sur des sites Internet, des forums et des FAQ francophones ou anglophones
- [x] Connaissance d'un environnement de développement intégré
- [x] Connaissance du vocabulaire anglais professionnel associé au web et aux solutions de gestion de contenu et e-commerce
- [x] Connaissance des concepts de la programmation objet
- [x] Connaissance de l’architecture d’un serveur web
- [ ] Connaissance des principales failles de sécurité des applications web (__XSS__, __CSRF__, …) et de leurs parades
- [x] Connaissance des bonnes pratiques de sécurisation du développement web (scripts clients et pages serveurs)
